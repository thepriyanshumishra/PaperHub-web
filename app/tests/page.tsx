            ...
            {!isCreatingCustom ? (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-text-muted mt-1 leading-relaxed">
                          Configure a combined subject test or custom syllabus scope!
                        </p>
                      </div>
                    </div>
                  ...
                  {/* PYQ Mock Tests Card */}
                  <button 
                    onClick={() => alert("Test series are curated below! Use 'Create Your Own Test' for dynamic mocks.")}
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="p-6 rounded-2xl border border-border-primary bg-bg-secondary/40 backdrop-blur-md space-y-6 max-w-2xl mx-auto relative overflow-hidden"
              >
                ...
                <div className="flex items-center justify-between border-b border-border-primary/45 pb-4">
                  <div>
                    <h3 className="font-display font-black text-base text-text-primary">Configure Custom Mock Quiz</h3>
                    <p className="text-[10px] text-text-secondary mt-0.5">Step {step} of {STEP_LABELS.length}: {STEP_LABELS[step - 1]}</p>
                  </div>
                  <button 
                    onClick={() => {
                ...
                {errorMessage && (
                  <div className="p-4 rounded-xl border border-red-500/25 bg-red-500/5 text-xs text-red-500 font-semibold flex items-center gap-2">
                ...
                <div className="flex items-center justify-between border-t border-border-primary/45 pt-4">
                  {step > 1 ? (
                    <button
                      onClick={goBack}
